...
const Menu = ({admin, logout, pageSelected, wallet}:Menu) => {
  ...
  return (
    <div className='flex flex-col w-full lg:max-w-[150px] sm:max-w-[450px] max-w-[90vw] shadow-[0_0_3px_#7E2A0C] justify-center items-center fixed sm:right-3 right-1/2 sm:translate-x-[0] translate-x-[50%] z-50 top-18 border-y-6 border-double border-orange-500 bg-white'>
